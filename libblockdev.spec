...
Source0  : https://github.com/storaged-project/libblockdev/releases/download/2.27-1/libblockdev-2.27.tar.gz
...
%prep
%setup -q -n libblockdev-2.27
cd %{_builddir}/libblockdev-2.27
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654191449
...
cp %{_builddir}/libblockdev-2.27/LICENSE %{buildroot}/usr/share/package-licenses/libblockdev/507ba5f4949dedff9e01b4d5b64b365fdc7d4d04
%make_install
