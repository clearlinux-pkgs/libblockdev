...
Source0  : https://github.com/storaged-project/libblockdev/releases/download/3.1.0-1/libblockdev-3.1.0.tar.gz
...
%prep
%setup -q -n libblockdev-3.1.0
cd %{_builddir}/libblockdev-3.1.0
pushd ..
cp -a libblockdev-3.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705700907
...
cp %{_builddir}/libblockdev-3.1.0/LICENSE %{buildroot}/usr/share/package-licenses/libblockdev/507ba5f4949dedff9e01b4d5b64b365fdc7d4d04 || :
pushd ../buildavx2/
%make_install_v3
popd
%make_install
