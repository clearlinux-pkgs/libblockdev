...
Version  : 3.3.1
Release  : 75
URL      : https://github.com/storaged-project/libblockdev/releases/download/3.3.1/libblockdev-3.3.1.tar.gz
Source0  : https://github.com/storaged-project/libblockdev/releases/download/3.3.1/libblockdev-3.3.1.tar.gz
...
%prep
%setup -q -n libblockdev-3.3.1
cd %{_builddir}/libblockdev-3.3.1
pushd ..
cp -a libblockdev-3.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750862512
...
cp %{_builddir}/libblockdev-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/libblockdev/507ba5f4949dedff9e01b4d5b64b365fdc7d4d04 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
/usr/lib64/libbd_smart.so
/usr/lib64/libbd_smartmontools.so
...
/V3/usr/lib64/libbd_smart.so.3.0.0
/V3/usr/lib64/libbd_smartmontools.so.3.0.0
...
/usr/lib64/libbd_smart.so.3
/usr/lib64/libbd_smart.so.3.0.0
/usr/lib64/libbd_smartmontools.so.3
/usr/lib64/libbd_smartmontools.so.3.0.0
